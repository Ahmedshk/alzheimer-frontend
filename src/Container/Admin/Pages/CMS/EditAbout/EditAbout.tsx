...
const EditAbout = () => {
  ...
  if (activeTab === "SECTION1") {
    showSection = <Section1 setIsFetching={setIsFetching} section1={getAboutSection1} />;
  } else if (activeTab === "SECTION2") {
    showSection = <Section2 setIsFetching={setIsFetching} section2={getAboutSection2} />;
  } else if (activeTab === "SECTION3") {
    showSection = <Section3 setIsFetching={setIsFetching} section3={getAboutSection3} />;
  } else if (activeTab === "SECTION4") {
    showSection = <Section4 setIsFetching={setIsFetching} section4={getAboutSection4} />;
  } else if (activeTab === "SECTION5") {
    showSection = <Section5 setIsFetching={setIsFetching} section5={getAboutSection5} />;
  }
