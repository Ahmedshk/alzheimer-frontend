...
import DeleteProfile from "./DelteProfile/DeleteProfile";
...
const EditProfile = () => {
  ...
  } else if (activeTab === profile.DELETE_PROFILE) {
    showSection = <DeleteProfile />;
  } 
          ...
          <Col md={3} className={"imgSection"}>
            ...
            <div className={"tabs"}>
              <ul>
                ...
                <li
                    className={activeTab === profile.DELETE_PROFILE ? "active" : ""}
                    onClick={() => setActiveTab(profile.DELETE_PROFILE)}
                >
                  <BiChevronRight />
                  Delete Profile
                </li>
